...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.7.9.3 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target svr2007_codegen'
add_custom_target(svr2007_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/svr2007_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for svr2007"
    VERBATIM
)
