...
# Codegen target - run 'cmake --build . --target wwesmackdownvsraw2007_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(wwesmackdownvsraw2007_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/wwesmackdownvsraw2007_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for wwesmackdownvsraw2007"
    VERBATIM
)